            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="card shadow mb-4">
                        ...
                        <h6 class="m-0 font-weight-bold text-primary">Courbe de contribution par Cellule</h6>
      ...
      yAxes: [{
        ticks: {
          ...
          callback: function(value, index, values) {
            return  number_format(value) + ' #BIF';
          }
        },
        gridLines: {
    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, chart) {
          ...
          return datasetLabel +  number_format(tooltipItem.yLabel) + ' #BIF';
        }
      }
    }
  }
